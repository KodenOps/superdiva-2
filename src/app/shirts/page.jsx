	...
	return (
		<div>
			<div className='min-h-[60vh]'>
				<UniqueCategory
					db={shirts}
					pageTitle='Our Exclusive Shirts'
					pageParagraph="Discover our curated collection of stylish women's shirts! Handpicked for their quality and design, these shirts are the epitome of fashion-forward choices. Explore now and elevate your wardrobe with exceptional styles and savings!"
				/>
			</div>
			<Footer />
		</div>
