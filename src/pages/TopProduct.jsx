...
const TopProduct = () => {
	return (
		<div className=" md:px-[50px] px-[10px] my-[100px] mb-[40px]" id="topProd">
			<Titles
			...
			<div className="product_Container flex flex-wrap gap-[24px] mt-[40px] justify-around items-center">
				{hotProductsDB.map((hotDB) => {
					return (
						<div
							key={hotDB.id}
							className="md:w-[200px] w-[160px] mb-[40px] hover:shadow-md shadow-sm cursor-pointer p-[10px] rounded-md duration-1000">
							<img
								src={hotDB.image}
								alt=""
